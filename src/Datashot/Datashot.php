...
class Datashot
{
    protected static $DRIVERS = [
      'mysql' => MysqlDatabaseSnapper::class
    ];
    ...
    {
        $this->conf->set("where", $this->wrap($string));
    }

    private function setWhereClause($table, $where)
    {
        $this->conf->set("wheres.{$table}", $this->wrap($where));
    }
    ...
    private function dumpSchema()
    {
        ...
        $this->appendMsg("Restoring database schema...");
        $this->appendOutput("
    ...
    {
        $outputDir = $this->conf->get('output_dir', getcwd());
